...
% \bibliography{sampleReport} -- add later in final report

\ifproject
\normalspacing
% \appendix
% \include{chapters/appendix}  -- add appendix later in final report
...
% \begin{biosketch}         -- add biosketch later in final report
% \begin{center}
